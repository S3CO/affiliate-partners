      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <button className="flex items-center justify-center px-4 py-3 border-2 border-gray-200 rounded-lg hover:bg-gray-50 transition">
        ...
        <div className="mt-8 text-center">
          <p className="text-white text-sm">
            🔒 Güvenli giriş • 7/24 destek • KVKK uyumlu
          </p>
        </div>
      </div>
    </div>
